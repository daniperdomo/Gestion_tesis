...
const Register = () => {
    const options = [
        ...
        { id: 7, title: 'Se Especializa', description: 'Registro de relacion entre profesores y especialidades', link: '/register/especializa'},
        { id: 8, title: 'Es Jurado', description: 'Registro de relacion entre jurados y propuestas', link: '/register/jurado'}
    ];
